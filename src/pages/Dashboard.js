    ...
    return (
        <>
            ...
            <div className="grid gap-6 mb-8 lg:grid-cols-3 md:grid-cols-1">
                ...
                <div className="md:col-span-2 min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div className="min-w-0 p-4 w-full rounded overflow-hidden shadow-xs dark:bg-gray-800">
